...
// 	protoc        v6.33.2
// source: game/mainsvr/v1/c2s.proto
...
var File_game_mainsvr_v1_c2s_proto protoreflect.FileDescriptor

const file_game_mainsvr_v1_c2s_proto_rawDesc = "" +
	"\n" +
	"\x19game/mainsvr/v1/c2s.proto\x12\x0fgame.mainsvr.v1\x1a\x1egoone/options/v1/options.proto\x1a1third_party/game_protocol/g1/protocol/stubs.proto\x1a\x1bgoogle/protobuf/empty.proto2\xfb-\n" +
...
var file_game_mainsvr_v1_c2s_proto_goTypes = []any{
...
var file_game_mainsvr_v1_c2s_proto_depIdxs = []int32{
...
func init() { file_game_mainsvr_v1_c2s_proto_init() }
func file_game_mainsvr_v1_c2s_proto_init() {
	if File_game_mainsvr_v1_c2s_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_game_mainsvr_v1_c2s_proto_rawDesc), len(file_game_mainsvr_v1_c2s_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_game_mainsvr_v1_c2s_proto_goTypes,
		DependencyIndexes: file_game_mainsvr_v1_c2s_proto_depIdxs,
	}.Build()
	File_game_mainsvr_v1_c2s_proto = out.File
	file_game_mainsvr_v1_c2s_proto_goTypes = nil
	file_game_mainsvr_v1_c2s_proto_depIdxs = nil
}
